...
const dict = {
  ko: {
    ...
    'proj.book.desc': '홀로서기 위해 100일간 떠난 여행지에서의 고독과 사색을 엮은 단상집입니다. 어느날 문득, 지금 내 삶에는 나 자신이 없다는 사실을 깨달음과 동시에 \'진정한 나는 어떤 사람인가?\'라는 질문이 머릿속을 맴돌았습니다. 질문은 총을 든 사격수였고, 저는 총구 속 실탄이었죠. 사격수는 과녁을 향해 내보냈고, 바람과 무중력 경계에 떠 있던 저는 결심했습니다. 누구에게도 기대지 않고, 어떤 요구에도 얽매이지 않는 곳에서 심연에 숨은 진짜 나를 찾아 나서기로요. 대륙을 오가는 기차 안에서, 런던 게이 클럽에서, 스위스 자연을 보며, 베를린 퀴어 퍼레이드 현장 속에서…. 내면을 탐색하는 과정은 시간과 장소에 구애받지 않았고, 독백 속에 떠오르는 문장들을 담기 시작했습니다. 때론 불안했고, 때론 공허했지만, 그럼에도 나아갔습니다. 고독했던 독백들이 춤추기 시작합니다. 당신의 이야기도 함께 춤추는 시간이 되길.',
    ...
    'proj.ex2.desc': '여름휴가는 언제부터 멀리 떠나는 일과 동의어가 되었을까? 나 역시 예외는 아니었다. 낯선 풍경 속에 들어서야 비로소 여름이 시작된다고 믿었다. 그러다 베를린의 동네 공원에서 멈춰 섰다. 풀밭 위에서 태닝을 하고, 친구들과 수다를 나누며 가볍게 웃는 사람들. 그들은 화려한 휴양지가 아닌 집 근처에서 아무렇지 않게 평범하고 완전한 여름을 누리고 있었다. 나는 그들의 일상에서 늘 갈망하던 쉼의 장면을 발견했다. 집을 떠나서 알게 된 사실은, 휴식이란 \'어디에 있느냐\'보다 \'어떻게 바라보느냐\'가 더 중요하다는 단순한 진실이었다. 그 허무하지만 분명한 깨달음이 이 전시의 출발점이 되었다. 우리 동네 공원은 언제부터 그저 스쳐 지나가는 회색 배경이 되었을까? 한강은 언제부터 관광지의 조연이 되었을까? 《일상의 여름》은 그 질문 끝에 남은 기록이다. 멀리 떠난 덕분에 오히려 가까운 것들의 가치를 다시 알게 된 담담한 여정이다. 여름은 거창한 모험이 아니라, 나무 그늘 아래 가만히 머무는 태도에서 피어난다.',
    'cat.poster': '포스터',
  ...
  en: {
    ...
    'proj.ex2.desc': 'When did summer holidays become synonymous with going far away? I was no exception — I believed summer only truly began when I stepped into an unfamiliar landscape. Then I stopped at a neighbourhood park in Berlin. People tanning on the grass, laughing lightly with friends. Not at some glamorous resort, but right near their homes — effortlessly living a complete, ordinary summer. I found in their everyday lives the scene of rest I had always longed for. What I learned by leaving home was a simple truth: rest is less about where you are and more about how you choose to see. That humble yet certain realisation became the starting point of this exhibition. When did our neighbourhood parks become grey backdrops we pass through without a second glance? When did the Han River become a side character in someone else\'s travel story? Ordinary Summer is the record left at the end of those questions — a quiet journey of rediscovering the value of what is close, made possible only by going far away. Summer does not bloom from grand adventures. It rises from the quiet act of staying still beneath the shade of a tree.',
    'cat.poster': 'Poster',
