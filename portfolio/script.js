...
const dict = {
  ko: {
    ...
    'proj.ex1.desc': '이런 계절의 흐름 속에서, 조용히 여름을 준비하는 작은 전시를 시작합니다. 자연스럽게 마음이 움직이게 되는 공간. 나른한 일상 속 피서의 기운이 당신의 하루에 은은히 스며들기를. 조용히, 그러나 확실히.',
    'proj.ex2.desc': '베를린의 동네 공원에서 멈춰 섰다. 그들은 집 근처에서 아무렇지 않게 평범하고 완전한 여름을 누리고 있었다. 휴식이란 어디에 있느냐보다 어떻게 바라보느냐가 더 중요하다는 단순한 진실. 여름은 거창한 모험이 아니라, 나무 그늘 아래 가만히 머무는 태도에서 피어난다.',
    'cat.poster': '포스터',
    'cat.toon': '치기툰',
  ...
  en: {
    ...
    'proj.ex1.desc': 'In the flow of this season, a quiet little exhibition begins. A space where your heart moves naturally. May the spirit of escape seep gently into your day. Quietly, but surely.',
    'proj.ex2.desc': 'I stopped at a neighbourhood park in Berlin. People were enjoying a perfectly ordinary summer, right there near home. The simple truth: rest is less about where you are than how you see. Summer blooms not from grand adventure, but from the quiet act of staying beneath the shade of a tree.',
    'cat.poster': 'Poster',
    'cat.toon': 'Toon',
